...
class Cust_Win:
    ...
    #idproof type combobox
        lb1IdProof=Label(labelframeleft,font=("arial",12,"bold"),text="Id Proof Type:", padx=2, pady=6)
    ...
    #=========================== Shoe Data Table ==================================
        ...
        self.Cust_Details_table = ttk.Treeview(
            details_table,
            columns=("ref", "name", "mother", "gender", "post", "mobile", "email", "nationality", "idproof", "idnumber",
                     "address"),
    ...
    def add_data(self):
        if self.var_mobile.get()=="" or self.var_mother.get()=="":
          ...
          try:
            conn=mysql.connector.connect(host="localhost",user="root",passwd="12Aug@99",database="hotel_management")
    ...
    def mDelete(self):
        mDelete=messagebox.askyesno("Hotel Management System","Do you really want to delete this customer?",parent=self.root)
        if mDelete>0:
            conn = mysql.connector.connect(host="localhost", user="root", passwd="12Aug@99",database="hotel_management")
            my_cursor = conn.cursor()
    ...
    def search(self):
        ...
        # 👇 Fix: Add space before LIKE and proper string quoting
        query = "SELECT * FROM customer WHERE " + str(self.search_var.get()) + " LIKE '%" + str(
            self.txt_search.get()) + "%'"
